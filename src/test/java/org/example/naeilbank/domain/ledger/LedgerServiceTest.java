...
class LedgerServiceTest {
    ...
    void ninthBalanceViewDoesNotSuggestAndTenthSuggestsOnce() {
        ...
        BalanceResponse tenth = service.balance(userId, "key-10");
        BalanceResponse eleventh = service.balance(userId, "key-11");
    ...
    void expiredWindowDoesNotSuggestBelowThreshold() {
        ...
        BalanceResponse response = service(Instant.parse("2026-08-20T02:00:00Z")).balance(userId, "after-window");
    ...
    void protectionModeChangesOnlyDisplayTextNotBalance() {
        ...
        BalanceResponse before = service.balance(userId, "before");
        user.enableProtectionMode();
        BalanceResponse after = service.balance(userId, "after");
